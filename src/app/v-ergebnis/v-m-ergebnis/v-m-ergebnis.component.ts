...
@Component({
  selector: 'app-v-m-ergebnis',
  templateUrl: './v-m-ergebnis.component.html',
  styleUrls: ['./v-m-ergebnis.component.css']
})

export class VMErgebnisComponent implements OnInit {
  mcfragen: Mcfragen[];
  ergebniss: any;
