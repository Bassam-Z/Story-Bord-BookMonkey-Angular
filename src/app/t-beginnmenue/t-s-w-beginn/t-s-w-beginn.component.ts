...
@Component({
  selector: 'app-t-s-w-beginn',
  templateUrl: './t-s-w-beginn.component.html',
  styleUrls: ['./t-s-w-beginn.component.css'],
})
export class TSWBeginnComponent implements OnInit {
  scfragen: Scfragen[];
  scfrage: Scfragen;
  index: number;
  ...
  goToergibns() {
    this.router.navigate([
      'prufung-lernen/prufmodus/teil-prufmodus/fwptfrage/p-t-s-w-start/t-s-w-beginn/t-s-ergebnis',
    ]);
  }
