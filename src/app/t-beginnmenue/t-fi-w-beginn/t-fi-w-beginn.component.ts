...
@Component({
  selector: 'app-t-fi-w-beginn',
  templateUrl: './t-fi-w-beginn.component.html',
  styleUrls: ['./t-fi-w-beginn.component.css'],
})

export class TFiWBeginnComponent implements OnInit {
  fifragen: Fifragen[];
  fifrage: Fifragen;
  index: number;
  ...
  goToergibns() {
    this.router.navigate([
      'prufung-lernen/prufmodus/teil-prufmodus/fwptfrage/p-t-fi-w-start/t-fi-w-beginn/t-fi-ergebnis',
    ]);
  }
