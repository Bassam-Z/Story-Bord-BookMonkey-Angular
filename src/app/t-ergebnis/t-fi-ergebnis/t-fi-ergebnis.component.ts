...
@Component({
  selector: 'app-t-fi-ergebnis',
  templateUrl: './t-fi-ergebnis.component.html',
  styleUrls: ['./t-fi-ergebnis.component.css']
})

export class TFiErgebnisComponent implements OnInit {
  fifragen: Fifragen[];
  ergebniss: any;
