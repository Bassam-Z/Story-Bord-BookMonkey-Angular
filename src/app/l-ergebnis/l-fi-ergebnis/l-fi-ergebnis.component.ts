...
@Component({
  selector: 'app-l-fi-ergebnis',
  templateUrl: './l-fi-ergebnis.component.html',
  styleUrls: ['./l-fi-ergebnis.component.css']
})

export class LFiErgebnisComponent implements OnInit {
  fifragen: Fifragen[];
  ergebniss: any;
