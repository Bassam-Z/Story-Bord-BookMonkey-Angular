...
@Component({
  selector: 'app-l-s-ergebnis',
  templateUrl: './l-s-ergebnis.component.html',
  styleUrls: ['./l-s-ergebnis.component.css']
})
export class LSErgebnisComponent implements OnInit {
  ...
  bestand: string;
  Nbestand: string;
  constructor(private sc: ScfragenService) { }
